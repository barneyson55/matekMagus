const TOPIC_ID = 'alapozo_modulzaro';
const TOPIC_NAME = 'Alapoz\u00f3 Modulok';
...
const TEST_QUESTION_TYPES = ["sum","difference","product","division","percent","fraction-add","linear-equation"];

const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ["sum","difference","product","division"],
  [DIFF_NORMAL]: ["linear-equation","percent","fraction-add","ratio"],
  [DIFF_HARD]: ["linear-equation","percent","fraction-add","ratio"]
};
