const TOPIC_ID = 'algebra_modulzaro';
const TOPIC_NAME = 'Algebra \u00e9s F\u00fcggv\u00e9nyek';
...
const TEST_QUESTION_TYPES = ["linear-equation","fraction-add","product","ratio","percent"];

const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ["sum","difference","product","division"],
  [DIFF_NORMAL]: ["linear-equation","fraction-add","ratio"],
  [DIFF_HARD]: ["linear-equation","fraction-add","percent"]
};
