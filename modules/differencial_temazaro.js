const TOPIC_ID = 'differencial_temazaro';
const TOPIC_NAME = 'Differenci\u00e1lsz\u00e1m\u00edt\u00e1s';
...
const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ["derivative-linear"],
  [DIFF_NORMAL]: ["derivative-linear","derivative-quadratic"],
  [DIFF_HARD]: ["derivative-quadratic"]
};
