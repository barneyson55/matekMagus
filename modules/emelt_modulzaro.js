const TOPIC_ID = 'emelt_modulzaro';
const TOPIC_NAME = 'Emelt Szint\u0171 Kieg\u00e9sz\u00edt\u00e9sek';
...
const TEST_QUESTION_TYPES = ["arith-nth","geom-nth","derivative-linear","integral-linear","integral-quadratic"];

const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ["arith-next","geom-next"],
  [DIFF_NORMAL]: ["arith-nth","geom-nth","derivative-linear"],
  [DIFF_HARD]: ["integral-linear","integral-quadratic","derivative-quadratic"]
};
