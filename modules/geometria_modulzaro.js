const TOPIC_ID = 'geometria_modulzaro';
const TOPIC_NAME = 'Geometria';
...
const TEST_DIFFICULTY_KEY = 'osszesito';
const TEST_QUESTION_TYPES = ["triangle-area","rect-area","circle-area","pythagoras","polygon-interior-angle"];

const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ["rect-area","triangle-area","rect-perimeter"],
  [DIFF_NORMAL]: ["triangle-area","circle-area","polygon-interior-angle"],
  [DIFF_HARD]: ["circle-area","pythagoras","polygon-interior-angle"]
};
