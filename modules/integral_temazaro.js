const TOPIC_ID = 'integral_temazaro';
const TOPIC_NAME = 'Integr\u00e1lsz\u00e1m\u00edt\u00e1s';
...
const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ["integral-linear"],
  [DIFF_NORMAL]: ["integral-linear","integral-quadratic"],
  [DIFF_HARD]: ["integral-quadratic"]
};
