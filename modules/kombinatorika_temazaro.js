const TOPIC_ID = 'kombinatorika_temazaro';
const TOPIC_NAME = 'Kombinatorika';
...
const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ["factorial","permutation"],
  [DIFF_NORMAL]: ["permutation","combination","factorial"],
  [DIFF_HARD]: ["combination","permutation"]
};
