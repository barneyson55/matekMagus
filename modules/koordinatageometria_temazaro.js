const TOPIC_ID = 'koordinatageometria_temazaro';
const TOPIC_NAME = 'Koordin\u00e1tageometria';
...
const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ["distance-points","midpoint-x","midpoint-y"],
  [DIFF_NORMAL]: ["distance-points","slope","midpoint-x"],
  [DIFF_HARD]: ["distance-points","slope","translation-x"]
};
