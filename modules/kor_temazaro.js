const TOPIC_ID = 'kor_temazaro';
const TOPIC_NAME = 'A K\u00f6r';
...
const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ["circle-area","circle-circumference"],
  [DIFF_NORMAL]: ["circle-area","circle-circumference"],
  [DIFF_HARD]: ["circle-area","circle-circumference","ratio"]
};
