const TOPIC_ID = 'sokszogek_temazaro';
const TOPIC_NAME = 'N\u00e9gyzetek \u00e9s Soksz\u00f6gek';
...
const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ["rect-area","rect-perimeter","polygon-interior-angle"],
  [DIFF_NORMAL]: ["polygon-interior-angle","triangle-area","rect-area"],
  [DIFF_HARD]: ["polygon-interior-angle","pythagoras","triangle-area"]
};
