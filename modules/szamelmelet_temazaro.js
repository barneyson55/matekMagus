const TOPIC_ID = 'szamelmelet_temazaro';
const TOPIC_NAME = 'Sz\u00e1melm\u00e9let \u00e9s Sz\u00e1mrendszerek';
...
const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ["gcd","lcm","remainder"],
  [DIFF_NORMAL]: ["gcd","lcm","division","remainder"],
  [DIFF_HARD]: ["gcd","lcm","linear-equation","remainder"]
};
