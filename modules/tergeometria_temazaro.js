const TOPIC_ID = 'tergeometria_temazaro';
const TOPIC_NAME = 'T\u00e9rgeometria';
...
const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ["volume-prism","volume-cylinder"],
  [DIFF_NORMAL]: ["volume-prism","volume-cylinder","rect-area"],
  [DIFF_HARD]: ["volume-prism","volume-cylinder","pythagoras"]
};
