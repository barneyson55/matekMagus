const TOPIC_ID = 'tukrozes';
const TOPIC_NAME = 'Tengelyes \u00e9s k\u00f6z\u00e9ppontos t\u00fckr\u00f6z\u00e9s';
...
const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ['reflect-x', 'reflect-y'],
  [DIFF_NORMAL]: ['reflect-y', 'reflect-origin'],
  [DIFF_HARD]: ['reflect-origin', 'reflect-x']
};
...
function buildQuestion(kind, difficulty) {
  ...
  if (kind === 'reflect-x') {
    ...
    expectedValue = -y;
    question = 'Az A(' + x + ',' + y + ') pont t\u00fck\u00f6rk\u00e9pe az x-tengelyre. Mi lesz az \u00faj y koordin\u00e1ta?';
    ...
    const y = randomInt(-8, 8);
    expectedValue = -x;
    question = 'Az A(' + x + ',' + y + ') pont t\u00fck\u00f6rk\u00e9pe a y-tengelyre. Mi lesz az \u00faj x koordin\u00e1ta?';
    answerString = formatNumber(expectedValue, 0);
  }
  else if (kind === 'reflect-origin') {
    const x = randomInt(-8, 8);
    const y = randomInt(-8, 8);
    expectedValue = -x;
    question = 'Az A(' + x + ',' + y + ') pont t\u00fck\u00f6rk\u00e9pe az orig\u00f3ra. Mi lesz az \u00faj x koordin\u00e1ta?';
    answerString = formatNumber(expectedValue, 0);
  }
