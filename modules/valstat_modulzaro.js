const TOPIC_ID = 'valstat_modulzaro';
const TOPIC_NAME = 'Val\u00f3sz\u00edn\u0171s\u00e9gsz\u00e1m\u00edt\u00e1s \u00e9s Statisztika';
...
const TEST_QUESTION_TYPES = ["probability","combination","mean","median","percent"];

const QUESTION_TYPES_BY_DIFFICULTY = {
  [DIFF_EASY]: ["probability","mean"],
  [DIFF_NORMAL]: ["probability","combination","mean"],
  [DIFF_HARD]: ["probability","combination","median"]
};
